 ...
 */
@NotThreadSafe
public final class TAuthExtLoginModule implements LoginModule {
  private Subject mSubject;
  private User mUser;

  /**
   * Constructs a new {@link TAuthExtLoginModule}.
   */
  public TAuthExtLoginModule() {}
  ...
  public boolean commit() throws LoginException {
    ...
    // get a OS user
    Principal user = getPrincipalUser(TAuthLoginModule.TAuthPrincipal.class.getName());
