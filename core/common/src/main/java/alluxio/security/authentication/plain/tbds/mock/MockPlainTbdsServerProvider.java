 ...
 */
@ThreadSafe
public final class MockPlainTbdsServerProvider extends Provider {
  private static final long serialVersionUID = 4583558117355348639L;

  public static final String NAME = "MockPlainTbds";
  public static final String MECHANISM = "MOCK-TBDS";
  public static final double VERSION = 1.0;

  /**
   * Constructs a new provider for the SASL server when using the PLAIN TBDS mechanism.
   */
  public MockPlainTbdsServerProvider() {
    super(NAME, VERSION, "Mock Plain Tbds server provider");
    put("SaslServerFactory." + MECHANISM, MockPlainTbdsServer.Factory.class.getName());
  }
}
