...
/**
 * Tests for load command. todo more test
 */
public final class Load2CommandIntegrationTest extends AbstractFileSystemShellTest {
  @Test
  ...
  public void loadFileWithLocalOption() throws Exception {
    ...
    sFsShell.run("load2", "--local", "/testFile");
    Assert.assertTrue(mOutput.toString().contains("loaded successfully sum : 1\tfailed : 0"));
